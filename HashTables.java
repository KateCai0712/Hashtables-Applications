...
class DataItem
   ...
   private String name;               // data item (key)
//--------------------------------------------------------------
   public DataItem(String n)          // constructor
      { name = n; }
//--------------------------------------------------------------
...
// -------------------------------------------------------------
   public int hashFunc(String key)
      {
      return key.length() % arraySize;       // hash function
      }
// -------------------------------------------------------------
...
// -------------------------------------------------------------
   public DataItem delete(String key)  // delete a DataItem
      ...
      while(hashArray[hashVal].getKey() != null)  // until empty cell,
         {                               // found the key?
